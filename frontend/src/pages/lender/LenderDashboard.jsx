  ...
  return (
    <div className="flex bg-[#F8FAFC] font-sans text-slate-800" style={{ height: '100dvh', overflow: 'hidden' }}>
      ...
      <div className={`flex-1 flex flex-col relative z-10 min-w-0 h-full transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] ${isSidebarHovered ? 'lg:ml-64' : 'lg:ml-[72px]'}`}>
        ...
        {/* Scrollable area wrapped cleanly with overflow-x-hidden and enhanced bottom padding */}
            ...
            <div className="w-full max-w-[1200px] mx-auto">
              ...
              <div className="flex flex-col xl:flex-row gap-5 lg:gap-6">
                ...
                <div className="w-full xl:w-[55%] flex flex-col gap-5 lg:gap-6">
                  ...
                  {/* Mixed Grid: Trust Card + Borrower Cards */}
                  <div className="mt-1 sm:mt-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
                      ...
                      {/* 1. GREEN TRUST CARD - Explicit Animation */}
                      <motion.div 
                      ...
                      {/* 2. YIELD CARD - Explicit Animation */}
                      <motion.div 
                      ...
                      {/* 3, 4. RECENT BORROWER CARDS - Explicit Animations to fix invisible gap bug */}
                      {loadingBids ? (
                        ...
                        recentBids.slice(0, 2).map((bid, index) => { // Sliced to 2 for perfect grid alignment
                          return (
                            <motion.div 
                              key={bid._id} 
